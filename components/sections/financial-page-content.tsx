...
import {
  ...
  financialHeading,
  financialIntro,
  financialPageHeroImage,
} from "@/lib/site-content";
import { fadeUp, headerStagger } from "@/lib/motion-variants";

function FinancialPageHero() {
  return (
    <section className="relative isolate overflow-hidden bg-secondary">
      <Image src={financialPageHeroImage} alt="" fill className="object-cover object-center" sizes="100vw" priority />
      ...
      >
        <motion.nav variants={fadeUp} aria-label="Breadcrumb" className="mb-4 text-sm text-white/70">
          <ol className="flex flex-wrap items-center gap-2">
            ...
            <li className="font-medium text-white">{financialHeading}</li>
          </ol>
        </motion.nav>
