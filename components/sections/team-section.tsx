    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.h2
            className="mt-1.5 text-lg font-bold leading-tight tracking-tight text-secondary sm:mt-3 sm:text-3xl lg:text-[2rem] xl:text-4xl"
            variants={fadeUpBlur}
          >
            {teamHeading}
          </motion.h2>
        ...
        <motion.div
          className="mt-6 flex w-full flex-wrap justify-center gap-x-3 gap-y-8 sm:mt-12 sm:gap-x-10 sm:gap-y-14 lg:mt-16 lg:gap-x-12 lg:gap-y-16"
